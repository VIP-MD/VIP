...
break
	    ...
	    if (isBan) throw mess.ban
                ZimBotInc.sendMessage(m.chat, { image: { url: 'https://ibb.co/txHW71s' }, caption: ` *🐦* ` }, { quoted: m })
            }
            break            
            case 'chat': {
                if (!isCreator) throw mess.owner
...
╰━━━━━━━━━━━━━━━━━━╯`,
      ...
      const buttonsDefault = [{ urlButton: { displayText: `SUBSCRIBE`, url : `https://bit.ly/HAGOZOX-ID` } }, { urlButton: { displayText: `GITHUB`, url : `PRIVATE😁😁😁` } },
   {					
					quickReplyButton: {
						displayText: 'SPEED',
						id: 'ping'
